...
@ 03,65 get dNascimento               valid dNascimento <= dAtual -5475
...
@ 09,04 get nMateria1 valid !empty(nMateria1)                    picture "@!"
@ 09,25 get nNotaAB1  valid nNotaAB1 >= 0 .and. nNotaAB1 <= 10   picture "99"
@ 09,30 get nFaltaAB1 valid nFaltaAB1 >= 0 .and. nFaltaAB1 < 500 picture "999"
@ 09,40 get nNotaAB2  valid nNotaAB2 >= 0 .and. nNotaAB2 <= 10   picture "99"
@ 09,45 get nFaltaAB2 valid nFaltaAB2 >= 0 .and. nFaltaAB2 < 500 picture "999"
@ 09,55 get nNotaAB3  valid nNotaAB3 >= 0 .and. nNotaAB3 <= 10   picture "99"
@ 09,60 get nFaltaAB3 valid nFaltaAB3 >= 0 .and. nFaltaAB3 < 500 picture "999"
@ 09,70 get nNotaAB4  valid nNotaAB4 >= 0 .and. nNotaAB4 <= 10   picture "99"
@ 09,75 get nFaltaAB4 valid nFaltaAB4 >= 0 .and. nFaltaAB4 < 500 picture "999"
read

@ 11,04 get nMateria2 valid !empty(nMateria2)                    picture "@!"
@ 11,25 get nNotaBB1  valid nNotaBB1 >= 0 .and. nNotaBB1 <= 10   picture "99"
@ 11,30 get nFaltaBB1 valid nFaltaBB1 >= 0 .and. nFaltaBB1 < 500 picture "999"
@ 11,40 get nNotaBB2  valid nNotaBB2 >= 0 .and. nNotaBB2 <= 10   picture "99"
@ 11,45 get nFaltaBB2 valid nFaltaBB2 >= 0 .and. nFaltaBB2 < 500 picture "999"
@ 11,55 get nNotaBB3  valid nNotaBB3 >= 0 .and. nNotaBB3 <= 10   picture "99"
@ 11,60 get nFaltaBB3 valid nFaltaBB3 >= 0 .and. nFaltaBB3 < 500 picture "999"
@ 11,70 get nNotaBB4  valid nNotaBB4 >= 0 .and. nNotaAB4 <= 10   picture "99"
@ 11,75 get nFaltaBB4 valid nFaltaBB4 >= 0 .and. nFaltaBB4 < 500 picture "999"
read

@ 13,04 get nMateria3 valid !empty(nMateria3)                    picture "@!"
@ 13,25 get nNotaCB1  valid nNotaCB1 >= 0 .and. nNotaCB1 <= 10   picture "99"
@ 13,30 get nFaltaCB1 valid nFaltaCB1 >= 0 .and. nFaltaCB1 < 500 picture "999"
@ 13,40 get nNotaCB2  valid nNotaCB2 >= 0 .and. nNotaCB2 <= 10   picture "99"
@ 13,45 get nFaltaCB2 valid nFaltaCB2 >= 0 .and. nFaltaCB2 < 500 picture "999"
@ 13,55 get nNotaCB3  valid nNotaCB3 >= 0 .and. nNotaCB3 <= 10   picture "99"
@ 13,60 get nFaltaCB3 valid nFaltaCB3 >= 0 .and. nFaltaCB3 < 500 picture "999"
@ 13,70 get nNotaCB4  valid nNotaCB4 >= 0 .and. nNotaCB4 <= 10   picture "99"
@ 13,75 get nFaltaCB4 valid nFaltaCB4 >= 0 .and. nFaltaCB4 < 500 picture "999"
read

@ 15,04 get nMateria4 valid !empty(nMateria4)                    picture "@!"
@ 15,25 get nNotaDB1  valid nNotaDB1 >= 0 .and. nNotaDB1 <= 10   picture "99"
@ 15,30 get nFaltaDB1 valid nFaltaDB1 >= 0 .and. nFaltaDB1 < 500 picture "999"
@ 15,40 get nNotaDB2  valid nNotaDB2 >= 0 .and. nNotaDB2 <= 10   picture "99"
@ 15,45 get nFaltaDB2 valid nFaltaDB2 >= 0 .and. nFaltaDB2 < 500 picture "999"
@ 15,55 get nNotaDB3  valid nNotaDB3 >= 0 .and. nNotaDB3 <= 10   picture "99"
@ 15,60 get nFaltaDB3 valid nFaltaDB3 >= 0 .and. nFaltaDB3 < 500 picture "999"
@ 15,70 get nNotaDB4  valid nNotaDB4 >= 0 .and. nNotaDB4 <= 10   picture "99"
