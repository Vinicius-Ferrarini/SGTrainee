...
//Codigo | Descricao Prod | QTD | Estoque | Desconto | Preco Un | Total Item '
      nLinha := nLinhaPadrao - 1
      @ nLinha++,02 say 'Codigo | Descricao Prod | QTD | Estoque | Desconto | Preco Un | Total Item '
      ...
      do while .t.
         ...
         elseif nCodigoDigitado == nCodigoBatata
            ...
            nVendaEstoque    := nTempEstoqueBatata
         else
         ...
         @ nLinha,34 say AllTrim(Str(nVendaEstoque))
         @ nLinha,49 say '%'
         @ nLinha,57 say AllTrim(Transform(nTempPreco,'@E9.99'))


         @ nLinha,28 get nVendaQuantidade valid nVendaQuantidade > 0 .and. nVendaQuantidade <= nTempEstoque    picture '999'
         @ nLinha,47 get nVendaDesconto   valid nVendaDesconto  >= 0 .and. nVendaDesconto   <= nTempDesconto   picture '99'
